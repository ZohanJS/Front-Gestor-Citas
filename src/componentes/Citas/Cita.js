...
function Cita({ cita }) {
    ...
    const { _id, idHorario, idSede, idCupo, idOdontologo, tipoCita } = cita;
    ...
    return (
        <tr className="cita">
            ...
            <td className="especialista">{idOdontologo.nombre} {idOdontologo.apellidos}</td>
            ...
            <td>
                <div>
                    ...
                    <Button onClick={() => push('/citas/editar', { cita })} className="btnIcon" id="edit"><FontAwesomeIcon icon={faPen}></FontAwesomeIcon></Button>
                </div>
            </td>
        </tr>
    )
